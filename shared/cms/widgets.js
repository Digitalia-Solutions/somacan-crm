...
export const WIDGET_DEFINITIONS = {
  ...
  ParagraphWidget: {
    ...
    fields: [{ name: 'text', label: 'Text', type: 'richtext' }],
    defaultProps: { text: 'Add supporting body copy here.' },
  },
  ButtonWidget: {
    type: 'ButtonWidget',
    label: 'Button',
    ...
    defaultProps: { label: 'Shop now', href: '/shop', variant: 'button-primary' },
  },
  ImageWidget: {
    type: 'ImageWidget',
    label: 'Image',
  ...
  ProductCardWidget: {
    ...
    defaultProps: { title: 'Product name', price: 'MAD 0', image: '', href: '/shop' },
  },
  CategoryCardWidget: {
    ...
    defaultProps: { title: 'Category name', description: '', image: '', href: '/shop' },
  },
  SpacerWidget: {
    type: 'SpacerWidget',
    label: 'Spacer',
