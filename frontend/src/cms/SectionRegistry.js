...
} from '../sections/sectionStyleUtils.js';

export const SECTION_REGISTRY = {
  ThreeProductHero: {
    type: 'ThreeProductHero',
    label: 'Hero Produit 3D',
    icon: 'sparkles',
    defaultContent: {
      eyebrow: 'Scene 3D',
    ...
    defaultSettings: { backgroundColor: '#f6efe2' },
    defaultAnimation: { type: 'fade-up', duration: 1000, delay: 0, triggerOnScroll: true },
    fields: [
      ...layoutFieldGroup(),
      ...
      { name: 'bottleColor', label: 'Couleur bouteille', type: 'color' },
      { name: 'capColor', label: 'Couleur bouchon', type: 'color' },
      { name: 'glowColor', label: 'Couleur glow', type: 'color' },
      { name: 'rotationSpeed', label: 'Vitesse rotation', type: 'text', placeholder: '0.45' },
      { name: 'floatIntensity', label: 'Intensité flottement', type: 'text', placeholder: '1.1' },
      { name: 'cameraDistance', label: 'Distance caméra', type: 'text', placeholder: '6.2' },
      { name: 'showSparkles', label: 'Afficher particules', type: 'switch' },
      { name: 'sparkleCount', label: 'Nombre particules', type: 'text', placeholder: '32' },
      ...typographyFieldGroup('title', 'Titre'),
      ...typographyFieldGroup('subtitle', 'Sous-titre'),
      ...typographyFieldGroup('description', 'Description'),
    ],
    settingsFields: [
  ...
  WheelHero: {
    ...
    fields: [
      ...
      { name: 'autoplayDelay', label: 'Délai autoplay (ms)', type: 'text', placeholder: '4500' },
      { name: 'pauseOnHover', label: 'Pause au survol', type: 'switch' },
      { name: 'showNavigation', label: 'Afficher les flèches', type: 'switch' },
      { name: 'loop', label: 'Boucle infinie', type: 'switch' },
      { name: 'transitionDuration', label: 'Durée transition (ms)', type: 'text', placeholder: '1500' },
      { name: 'wheelDepth', label: 'Profondeur 3D', type: 'text', placeholder: '400' },
      { name: 'imageWidth', label: 'Largeur image mobile', type: 'text', placeholder: '280px' },
      { name: 'imageWidthMd', label: 'Largeur image tablette', type: 'text', placeholder: '450px' },
      { name: 'imageWidthXl', label: 'Largeur image desktop XL', type: 'text', placeholder: '580px' },
      ...typographyFieldGroup('heroName', 'Nom produit'),
      ...typographyFieldGroup('heroDescription', 'Description produit'),
      {
        name: 'products',
        ...
        fields: [
          ...
          { name: 'nameColor', label: 'Couleur nom', type: 'color' },
          { name: 'nameSize', label: 'Taille nom', type: 'text' },
          { name: 'priceColor', label: 'Couleur prix', type: 'color' },
          { name: 'priceSize', label: 'Taille prix', type: 'text' },
          ...mediaFieldGroup('image', 'Image produit'),
        ],
      },
    ],
    settingsFields: [
  ...
  Hero: {
    ...
    defaultSettings: {
      ...
      backgroundGradient: 'linear-gradient(135deg, #fcfaf7 0%, #f3eee4 100%)',
      minHeight: '92vh',
    },
    ...
    fields: [
      ...
      { name: 'showMiniStats', label: 'Afficher mini-stats', type: 'switch' },
      { name: 'showScrollIndicator', label: 'Afficher indicateur scroll', type: 'switch' },
      ...typographyFieldGroup('title', 'Titre'),
      ...typographyFieldGroup('subtitle', 'Sous-titre'),
      ...typographyFieldGroup('description', 'Description'),
      ...mediaFieldGroup('heroImage', 'Image fond'),
      ...mediaFieldGroup('productImage', 'Image produit'),
    ],
    settingsFields: [
      {
        name: 'backgroundType',
        ...
        options: [
          ...
          { label: 'Dégradé linéaire', value: 'gradient' },
          { label: 'Image', value: 'image' },
        ],
      },
      { name: 'backgroundColor', label: 'Couleur de fond', type: 'color' },
      { name: 'backgroundGradient', label: 'Dégradé linéaire (CSS)', type: 'text', placeholder: 'linear-gradient(135deg, #fcfaf7 0%, #f3eee4 100%)' },
      { name: 'backgroundImage', label: 'Image de fond', type: 'image' },
      {
        name: 'backgroundImageFit',
        label: 'Image fond fit',
        type: 'select',
        options: ['cover', 'contain', 'fill', 'none', 'scale-down'].map((value) => ({ label: value, value })),
      },
      { name: 'backgroundImagePosition', label: 'Image fond position', type: 'text', placeholder: 'center center' },
      { name: 'backgroundImageOpacity', label: 'Image fond opacity', type: 'text', placeholder: '0.6' },
  ...
  FeaturesBar: {
    ...
    defaultAnimation: { type: 'none' },
    fields: [
      { name: 'paddingY', label: 'Padding vertical', type: 'text', placeholder: '4rem' },
      { name: 'itemGap', label: 'Espacement éléments', type: 'text', placeholder: '3rem' },
      { name: 'itemColor', label: 'Couleur du texte', type: 'color' },
      { name: 'dividerColor', label: 'Couleur des séparateurs', type: 'color' },
      {
        name: 'items',
  ...
  CategorySection: {
    ...
    fields: [
      ...
      { name: 'showAllLink', label: 'Lien voir tout', type: 'text', placeholder: '/shop' },
      { name: 'cardHeight', label: 'Hauteur cartes', type: 'text', placeholder: '500px' },
      { name: 'gridGap', label: 'Gap grille', type: 'text', placeholder: '1rem' },
      { name: 'showAllLabel', label: 'Texte lien voir tout', type: 'text' },
      { name: 'cardEyebrow', label: 'Eyebrow des cartes', type: 'text', placeholder: 'Somacan Collections' },
      { name: 'emptyMessage', label: 'Message si vide', type: 'text' },
      { name: 'showProductCount', label: 'Afficher le nombre de produits', type: 'switch' },
      ...typographyFieldGroup('title', 'Titre'),
      ...typographyFieldGroup('subtitle', 'Sous-titre'),
      ...typographyFieldGroup('cardTitle', 'Titre carte'),
      ...mediaFieldGroup('cardImage', 'Image carte'),
      {
        name: 'categoryIds',
  ...
  ProductsShowcase: {
    ...
    fields: [
      ...
      { name: 'maxItems', label: 'Nombre max produits', type: 'text', placeholder: '8' },
      { name: 'trackGap', label: 'Gap cards', type: 'text', placeholder: '1.5rem' },
      { name: 'cardWidth', label: 'Largeur card', type: 'text', placeholder: '18rem' },
      ...typographyFieldGroup('title', 'Titre'),
      ...typographyFieldGroup('subtitle', 'Sous-titre'),
    ],
    settingsFields: [
  ...
  StorySection: {
    ...
    fields: [
      ...
      ...typographyFieldGroup('title', 'Titre'),
      ...typographyFieldGroup('paragraph1', 'Paragraphe 1'),
      ...typographyFieldGroup('paragraph2', 'Paragraphe 2'),
      ...mediaFieldGroup('image', 'Image'),
    ],
    settingsFields: [
      { name: 'backgroundColor', label: 'Couleur de fond', type: 'color' },
    ],
  ...
  ExpertiseSection: {
    ...
    fields: [
      ...
      { name: 'introMaxWidth', label: 'Largeur max intro', type: 'text', placeholder: '20rem' },
      { name: 'itemGap', label: 'Gap interne carte', type: 'text', placeholder: '2rem' },
      { name: 'itemPadding', label: 'Padding carte', type: 'text', placeholder: '2.5rem' },
      { name: 'numberColor', label: 'Couleur numéro', type: 'color' },
      { name: 'titleColor', label: 'Couleur titre carte', type: 'color' },
      { name: 'textColor', label: 'Couleur texte carte', type: 'color' },
      {
        name: 'items',
        label: 'Piliers',
        type: 'repeater',
  ...
  StatsSection: {
    ...
    fields: [
      { name: 'maxWidth', label: 'Largeur max bloc', type: 'text', placeholder: '100rem' },
      { name: 'cardRadius', label: 'Rayon bloc stats', type: 'text', placeholder: '2rem' },
      { name: 'cardPaddingX', label: 'Padding horizontal carte', type: 'text', placeholder: '2rem' },
      { name: 'cardPaddingY', label: 'Padding vertical carte', type: 'text', placeholder: '2.75rem' },
      { name: 'valueColor', label: 'Couleur valeur', type: 'color' },
      { name: 'labelColor', label: 'Couleur label', type: 'color' },
      { name: 'descColor', label: 'Couleur description', type: 'color' },
      {
        name: 'items',
        label: 'Statistiques',
        type: 'repeater',
  ...
  OfferSection: {
    ...
    fields: [
      ...
      { name: 'badgeSize', label: 'Taille badge', type: 'text', placeholder: '10rem' },
      { name: 'textMaxWidth', label: 'Largeur max texte', type: 'text', placeholder: '28rem' },
      { name: 'imageAspectRatio', label: 'Ratio image', type: 'text', placeholder: '4 / 5' },
      ...typographyFieldGroup('title', 'Titre'),
      ...typographyFieldGroup('subtitle', 'Sous-titre'),
      ...typographyFieldGroup('description', 'Description'),
      ...mediaFieldGroup('image', 'Image'),
  ...
  TestimonialsSection: {
    ...
    defaultContent: {
      ...
      subtitle: 'de Somacan.',
      footerNote: '4.9/5 · plus de 800 avis verifies',
      items: [
        {
    ...
    fields: [
      ...
      { name: 'title', label: 'Titre', type: 'text' },
      { name: 'subtitle', label: 'Sous-titre italique', type: 'text' },
      { name: 'footerNote', label: 'Note de bas de section', type: 'text' },
      { name: 'autoplay', label: 'Autoplay', type: 'switch' },
      { name: 'autoplayDelay', label: 'Délai autoplay (ms)', type: 'text', placeholder: '4800' },
      { name: 'pauseOnHover', label: 'Pause au survol', type: 'switch' },
      { name: 'loop', label: 'Boucle infinie', type: 'switch' },
      { name: 'speed', label: 'Vitesse transition (ms)', type: 'text', placeholder: '1000' },
      { name: 'showPagination', label: 'Afficher pagination', type: 'switch' },
      ...typographyFieldGroup('title', 'Titre'),
      ...typographyFieldGroup('subtitle', 'Sous-titre'),
      ...typographyFieldGroup('quote', 'Citation'),
      ...typographyFieldGroup('author', 'Auteur'),
      {
        name: 'items',
        label: 'Avis clients',
        type: 'repeater',
  ...
  FaqSection: {
    ...
    fields: [
      ...
      { name: 'ctaText', label: 'Texte lien', type: 'text' },
      { name: 'ctaLink', label: 'URL lien', type: 'text' },
      { name: 'itemsGap', label: 'Espacement entre items', type: 'text', placeholder: '1.25rem' },
      { name: 'emptyMessage', label: 'Message si la FAQ est vide', type: 'text' },
      { name: 'allowMultipleOpen', label: 'Ouvrir plusieurs items', type: 'switch' },
      { name: 'defaultOpenIndex', label: 'Index ouvert par défaut', type: 'text', placeholder: '0' },
      ...typographyFieldGroup('headline', 'Titre'),
      ...typographyFieldGroup('description', 'Description'),
      ...typographyFieldGroup('question', 'Question'),
      ...typographyFieldGroup('answer', 'Réponse'),
      {
        name: 'items',
  ...
  ShopHero: {
    ...
    fields: [
      ...
      { name: 'minHeight', label: 'Hauteur min', type: 'text', placeholder: '42rem' },
      { name: 'showDescriptionOnMobile', label: 'Afficher description sur mobile', type: 'switch' },
    ],
    settingsFields: [
      { name: 'backgroundColor', label: 'Couleur de fond', type: 'color' },
    ],
  ...
  BlogHero: {
    ...
    fields: [
      ...
      { name: 'titleItalic', label: 'Titre ligne 2 (italique)', type: 'text' },
      { name: 'description', label: 'Description', type: 'textarea' },
      { name: 'contentMaxWidth', label: 'Largeur max section', type: 'text', placeholder: '80rem' },
      { name: 'descriptionMaxWidth', label: 'Largeur max description', type: 'text', placeholder: '28rem' },
    ],
    settingsFields: [{ name: 'backgroundColor', label: 'Couleur de fond', type: 'color' }],
  },
  ...
  NewsletterSection: {
    ...
    fields: [
      ...
      { name: 'formMaxWidth', label: 'Largeur max formulaire', type: 'text', placeholder: '32rem' },
      ...typographyFieldGroup('title', 'Titre'),
      ...typographyFieldGroup('subtitle', 'Sous-titre'),
      ...typographyFieldGroup('description', 'Description'),
    ],
  ...
  BlogPreview: {
    ...
    fields: [
      ...
      { name: 'ctaText', label: 'Texte lien', type: 'text' },
      { name: 'ctaLink', label: 'URL lien', type: 'text' },
      { name: 'maxItems', label: 'Nombre max articles', type: 'text', placeholder: '3' },
      { name: 'gridGap', label: 'Gap grille', type: 'text', placeholder: '2rem' },
      { name: 'emptyMessage', label: 'Message si vide', type: 'text' },
      { name: 'cardAspectRatio', label: 'Ratio image carte', type: 'text', placeholder: '4 / 5' },
      ...typographyFieldGroup('title', 'Titre'),
      ...typographyFieldGroup('subtitle', 'Sous-titre'),
      ...typographyFieldGroup('cardTitle', 'Titre carte'),
      ...typographyFieldGroup('cardExcerpt', 'Extrait carte'),
      ...mediaFieldGroup('cardImage', 'Image carte'),
    ],
    settingsFields: [],
  },
